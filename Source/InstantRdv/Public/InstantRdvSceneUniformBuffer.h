...
BEGIN_SHADER_PARAMETER_STRUCT(FInstantRdvSceneUniformBufferParams, )
    ...
    SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<float4>, FspIrradianceVolumeSH)
    ...
    SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<uint>, BbvBitmaskBrickVoxel)
    SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<uint>, BbvBrickData)
